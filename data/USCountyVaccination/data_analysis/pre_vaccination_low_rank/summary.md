...
- `Continuous death-rate matrix`: `48` weeks x `3213` counties from column `death_rate_100k`
- `Binary death-threshold matrix`: `48` weeks x `3213` counties from column `x_death_rate_100k_ge_2_pm1`
...
- Raw matrix: `weak` low-rank evidence; top component explains `0.3151` of spectral energy and `24` components explain `95%`.
- After row-and-column centering: `weak` low-rank evidence; top component explains `0.1854` of spectral energy and `26` components explain `95%`.
- Elbow summary after row-and-column centering: strongest adjacent singular-value drop at rank `1` with ratio `1.3499`.

### Binary death-threshold matrix

- Raw matrix: `weak` low-rank evidence; top component explains `0.4903` of spectral energy and `30` components explain `95%`.
- After row-and-column centering: `weak` low-rank evidence; top component explains `0.1276` of spectral energy and `34` components explain `95%`.
- Elbow summary after row-and-column centering: strongest adjacent singular-value drop at rank `2` with ratio `1.3494`.
